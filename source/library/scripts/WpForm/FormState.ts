...
export default class FormState<ResponceType = any> {
    ...
    public async submit(): Promise<void> {
        ...
        // Support for reCAPTCHA module from vendor/ThemeCore
        try {
            //@ts-ignore
            await window.populateFormDataWithRecaptcha(formData);
        } catch (error) {
            console.error('Error populating FormData with reCAPTCHA:', error);
        }
